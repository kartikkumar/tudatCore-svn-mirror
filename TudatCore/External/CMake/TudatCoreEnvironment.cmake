# \file TudatCoreEnvironment.cmake
 ...
 #                                    yet been set before loading this scrip
 #/
...
if ("${PROJECT_NAME}" STREQUAL "TudatCore")
	...
	# Only load BOOST_ROOT if that variable does not exist in cmake and the user envoirmental variables
	if (NOT BOOST_ROOT AND NOT DEFINED ENV{BOOST_ROOT} )
    	set(BOOST_ROOT "${CMAKE_CURRENT_LIST_DIR}/boost")
	endif()
	# Only load BOOST_INCLUDEDIR if that variable does not exist in cmake and the user envoirmental variables
	if (NOT BOOST_INCLUDEDIR AND NOT DEFINED ENV{BOOST_INCLUDEDIR} )
    	#set(BOOST_INCLUDEDIR "${CMAKE_CURRENT_LIST_DIR}/boost")
	endif()
	# Only load BOOST_LIBRARYDIR if that variable does not exist in cmake and the user envoirmental variables
